    ...
    <div className="flex items-center justify-center">
      <div className=" w-1/2 mt-10 rounded-lg border shadow">
        <div className="flex items-center justify-center pt-10 flex-col">
          ...
          <h1 className="text-gray-800 text-sm">Dhaka, Bangladesh</h1>
          <p className="text-gray-800 text-sm p-4 text-center">
            Lorem ipsum dolor, sit amet consectetur adipisicing elit. Architecto
            facere voluptates nesciunt magni repudiandae laudantium iste ab,
            corporis itaque repellat error praesentium soluta sint blanditiis
            est dolorem, suscipit consequatur. Quod.
          </p>
        </div>
