const Features = () => {
    return ( 
        <div className="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-10">
            ...
            <div className="grid  grid-cols-2 md:grid-cols-4 gap-5 ms-5 mt-5 justify-center p-3 text-center">

                {/* Card 1 */}
                <div class=" p-6 shadow bg-white border  border-gray-200 rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-500  ">
