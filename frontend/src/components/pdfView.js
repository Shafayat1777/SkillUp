const PdfView = ({content, handleCloseWindow}) => {
  ...
  return (
    <div className="fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center h-screen bg-blue-950 bg-opacity-60">
      <div className="bg-white rounded-md relative">
        <h1 className="p-4 font-bold text-xl text-gray-600">Slides</h1>
