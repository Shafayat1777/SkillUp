          ...
          <div className="w-full lg:w-1/2 py-16 px-12">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-5 relative">
                ...
                <button className="absolute inset-y-0 right-0 flex items-center px-4 text-gray-600" onClick={(e)=>{
                    togglePassword(e)
                  }}>
                    {passwordType === "password" ? <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-gray-600">
