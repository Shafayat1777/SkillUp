        ...
        <div>
            ...
            <div className="w-full bg-gray-100 px-10 pt-10">
                <div className=" mx-auto">
                    <div className="flex items-center xl:justify-evenly  flex-wrap md:justify-around sm:justify-around lg:justify-around">
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 hover:scale-105 hover:-translate-y-1 duration-300 transition ease-in-out delay-150">
                            <div className="rounded overflow-hidden shadow-md   bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="https://pbs.twimg.com/media/E3QwqOHVEAEbuRR.jpg" alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Fahim Rayhan</div>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 hover:scale-105 hover:-translate-y-1 duration-300 transition ease-in-out delay-150">
                            <div className="rounded overflow-hidden shadow-md  bg-white">
                                ...
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">MD Shafayat Hossain</div>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 hover:scale-105 hover:-translate-y-1 duration-300 transition ease-in-out delay-150">
                            <div className="rounded overflow-hidden shadow-md  bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="https://i.pinimg.com/564x/b1/39/93/b139938a1e52fd74363f1d27afeffd10.jpg" alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Rizvee Hassan Prito</div>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 hover:scale-105 hover:-translate-y-1 duration-300 transition ease-in-out delay-150">
                            <div className="rounded overflow-hidden shadow-md  bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="https://scontent.fdac138-1.fna.fbcdn.net/v/t31.18172-8/19452830_427385380994100_3502036346731400645_o.jpg?_nc_cat=108&ccb=1-7&_nc_sid=8bfeb9&_nc_eui2=AeHwehEOnY5GrHPbDYStyoKvQj8GQELnnvNCPwZAQuee83-Ah0-ZwmLklYibiIvgMLt3bZvF7tUDCRsB77D1bP1L&_nc_ohc=lSvXKJ6UBPMAX-FrDVj&_nc_ht=scontent.fdac138-1.fna&oh=00_AfC8qgHqIjg8c96_Lmsid7WtdrJg5iFqdHCvUZafWLG59Q&oe=651EEB7B" alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Fahmida Afrose Dipti</div>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 hover:scale-105 hover:-translate-y-1 duration-300 transition ease-in-out delay-150">
                            <div className="rounded overflow-hidden shadow-md  bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="https://scontent.fdac138-2.fna.fbcdn.net/v/t39.30808-1/362298407_1271095733536171_9010649845732123723_n.jpg?stp=dst-jpg_p100x100&_nc_cat=102&ccb=1-7&_nc_sid=fe8171&_nc_eui2=AeEkfseJbIGU6fPW0Y0E1EIyV0XVP1StPiNXRdU_VK0-I14hArCRvNMIifqr2Ct550jEZO0MlrphQ5ynbyBmY6eP&_nc_ohc=wZQIZC4d6TAAX8GkDdO&_nc_ht=scontent.fdac138-2.fna&oh=00_AfAZVh4kwG0lKWBjbG1G74GoOcWL0zwEuJ1Kl8V0o2xhhA&oe=64FD4F6C" alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Turna Mehzabin</div>
                                    <p className="text-gray-800 text-sm text-center">Product Design Head</p>
                        ...
                        <div className="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5 hover:scale-105 hover:-translate-y-1 duration-300 transition ease-in-out delay-150">
                            <div className="rounded overflow-hidden shadow-md  bg-white">
                                <div className="absolute -mt-20 w-full flex justify-center">
                                    <div className="h-32 w-32">
                                        <img src="https://scontent.fdac138-1.fna.fbcdn.net/v/t39.30808-6/357444333_3475366289398859_5280198959854328234_n.jpg?stp=cp6_dst-jpg&_nc_cat=108&ccb=1-7&_nc_sid=52f669&_nc_eui2=AeEmw4xmo-pRPdTyIzfjKo0XWXShb4mhHjJZdKFviaEeMlSPb4S5P54MBJTOWnHUg_wEVmAL3_0_cDMj_zFrlTkg&_nc_ohc=1ot_pAXK714AX9WR6mh&_nc_ht=scontent.fdac138-1.fna&oh=00_AfBnINUN3jq8eBVfx8sxUxtn7XbkF9FSnSKoYvGQ9bdKiA&oe=64FCE48B" alt className="rounded-full object-cover h-full w-full shadow-md" />
                                    </div>
                                </div>
                                <div className="px-6 mt-16">
                                    <div className="font-bold text-3xl text-center pb-1">Nusrat Sultana</div>
